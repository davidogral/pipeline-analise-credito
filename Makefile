...
analytics: ## Roda as consultas de sql/ sobre as camadas locais
...
airflow-up: ## Sobe Airflow + PostgreSQL em http://localhost:8080 (admin/admin)
	docker compose --profile airflow up -d

clean: ## Remove as saídas geradas
	rm -rf data/bronze data/silver data/gold data/reports .pytest_cache .ruff_cache
